...
colnames(Final_Beta_RS)<-c("Method","Sample",paste0("Beta",1:6))
```
...
colnames(Final_Beta_LS)<-c("Method","Sample",paste0("Beta",1:6))
```
...
colnames(Final_Beta_ALoptGLM)<-c("Method","Sample",paste0("Beta",1:6))
```
...
colnames(Final_Beta_AoptMCGLM)<-c("Method","Sample",paste0("Beta",1:6))
```
