...
The data contains $4$ columns and has $2,049,280$ observations, first column is the response variable and the rest are covariates, however we only use $1\%$ of the data for this explanation. 
...
```{r Exploring data}
indexes<-sample(1:nrow(Electric_consumption),nrow(Electric_consumption)*0.01)
