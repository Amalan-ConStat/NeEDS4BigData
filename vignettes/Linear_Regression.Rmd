...
For each model $l$ the mean squared error of the model parameters $MSE_l(\tilde{\beta}_k,\hat{\beta})=\frac{1}{MJ} \sum_{i=1}^M \sum_{j=1}^J (\tilde{\beta}_{k,j} - \hat{\beta}_j)^2$ are calculated for the $M=250$ simulations across the sample sizes $k=(800,\ldots,2000)$ and the initial sample size is $r1=400$. 
...
NeEDS4BigData::modelRobustLinSub(r1=400,r2=rep_k,
...
for (i in 1:length(All_Models)) {
  ...
  data.frame("Method"=Final_Beta_modelRobust[[i]]$Method,
             ...
             "SE"=rowSums((All_Beta-Final_Beta_modelRobust[[i]][,-c(1,2)])^2))->MSE_Beta_MR
...
NeEDS4BigData::modelMissLinSub(r1=400,r2=rep_k,
