...
For each model $l$ the mean squared error of the model parameters $MSE_l(\tilde{\beta}_k,\hat{\beta})=\frac{1}{MJ} \sum_{i=1}^M \sum_{j=1}^J (\tilde{\beta}_{k,j} - \hat{\beta}_j)^2$ are calculated for the $M=250$ simulations across the sample sizes $k=(800,\ldots,2000)$ and the initial sample size is $r0=400$. 
...
NeEDS4BigData::modelRobustLinSub(r0=400,r=rep_k,
...
NeEDS4BigData::modelMissLinSub(r0=400,r=rep_k,
