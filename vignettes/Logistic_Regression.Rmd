...
To achieve this goal, the ``Skin segmentation data'' was curated, this data contains $4$ columns and has $245,057$ observations, first column is the response variable and the rest are covariates, however we only use $25\%$ of the data for this demonstration.
