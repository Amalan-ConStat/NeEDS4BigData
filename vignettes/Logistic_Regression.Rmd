...
```{r Potential model misspecification methods,fig.width=6,fig.height=5,fig.align='center', warning=FALSE,fig.cap="AMSE for the potentially misspecified main effects model across the subsampling methods under comparison." }
# Define the subsampling methods and their respective colours, shapes and line types
