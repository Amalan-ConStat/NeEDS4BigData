---
title: "Model based Sampling for Poisson Regression"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Model based Sampling for Poisson Regression}
...
Based on this model the methods random sampling, leverage sampling [@ma2014statistical;@ma2015leveraging], $A$- and $L$-optimality subsampling [@ai2021optimal;@yao2021review] and $A$-optimality sampling with response constraint [@zhang2021optimal] are implemented on the big data.

```{r define sampling methods}
...
```{r A-optimality sampling with measurement constraints}
...
```{r First scenario model parameter estimates,fig.width=7,fig.height=12,fig.align='center',fig.cap="Mean squared error for a) all the sampling methods and b) without unweighted leverage sampling."}
