...
However, its massive scale and complexity introduce novel computational and statistical hurdles. 
...
Meanwhile, online updating is primarily utilized for streaming data. Furthermore, when a large dataset is unnecessary to confidently answer a specific question, subsampling is often favoured, as it allows for analysis using standard methods.
