...
1. Sample randomly from the large dataset using sampling probabilities determined via an assumed statistical model and objective (e.g., prediction and/or parameter estimation) [@wang2018optimal;@yao2019softmax;@ai2020quantile;@ai2021optimal;@lee2021fast;@zhang2021optimal;@lee2022sampling]
...
5. A- and L-optimality based sampling methods for Generalised Linear Models under response not involved in probability calculation by @zhang2021optimal.
6. A- and L-optimality based model robust/average subsampling methods for Generalised Linear Models by @mahendran2023model.
7. Sampling for Generalised Linear Models under potential model misspecification as by @adewale2009robust and @adewale2010robust.
