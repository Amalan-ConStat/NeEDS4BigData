...
For large data sizes $N = \{10^4,5 \times 10^4,10^5,5 \times 10^5,10^6,5 \times 10^6\}$, three different covariate sizes $\{5,10,25,50,100\}$, and three different model sizes $\{3,5,10\}$, the functions were replicated 50 times.
