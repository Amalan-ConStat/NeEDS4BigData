...
#'
#' @details
#' Two stage sampling algorithm for big data under Poisson regression for potential model misspecification.
#'
...
modelMissPoiSub <- function(r1,r2,Y,X,N,Alpha,Beta_Estimate_Full,F_Estimate_Full){
  ...
  # For the Model with already available sampling probabilities - mMSE and mVc
  ...
  # For the Model with model robust sampling probabilities RLmAMSE
