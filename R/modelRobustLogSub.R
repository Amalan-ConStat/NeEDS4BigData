...
#'
#' @usage
#' modelRobustLogSub(r1,r2,Y,X,N,Apriori_probs,All_Combinations,All_Covariates)
#'
...
#' @export
modelRobustLogSub <- function(r1,r2,Y,X,N,Apriori_probs,All_Combinations,All_Covariates){
