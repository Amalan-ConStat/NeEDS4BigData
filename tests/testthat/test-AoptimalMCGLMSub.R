...
test_that("Error on input for r2",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = c(r2,NA),
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
...
test_that("Error on X input",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = r2,
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
...
test_that("Error on r1 and r2 input",{
  expect_error(AoptimalMCGLMSub(r1 = r1+1000, r2 = r2,
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
...
test_that("Error on length of r1, N or family",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = r2,
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
                                family = c("linear","logistic")),"r1, N or family has a value greater than length one")
})
...
test_that("Error on input for r2",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = c(r2,NA),
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
                                family = "poisson"),"NA or Infinite or NAN values in the r1,r2,N or family")
})
Original_Data[100,]<-rep(NA,4)
test_that("Error on X input",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = r2,
...
test_that("Error on r1 and r2 input",{
  expect_error(AoptimalMCGLMSub(r1 = r1+1000, r2 = r2,
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
                                X = as.matrix(Original_Data[,-1]),N = nrow(Original_Data),
                                family = "poisson"),"2*r1 cannot be greater than r2 at any point")
})
test_that("Error on size of X and Y",{
  expect_error(AoptimalMCGLMSub(r1 = r1, r2 = r2,
                                Y = as.matrix(Original_Data[,colnames(Original_Data) %in% c("Y")]),
