...
Results<-modelMissLogSub(r0 = r0, r = r,Y = as.matrix(Original_Data[,1]),
...
test_that("Error on input for r",{
  expect_error(modelMissLogSub(r0 = r0, r = c(r,NA),Y = as.matrix(Original_Data[,1]),
                               X = as.matrix(Original_Data[,-1]),
...
test_that("Error on X input",{
  expect_error(modelMissLogSub(r0 = r0, r = r,Y = as.matrix(Original_Data[,1]),
                               X = as.matrix(Original_Data[,-1]),
                               N = N,Alpha = 10, proportion = 0.3),
...
test_that("Error on r0 and r input",{
  expect_error(modelMissLogSub(r0 = r0+1000, r = r,Y = as.matrix(Original_Data[,1]),
                               X = as.matrix(Original_Data[,-1]),
                               N = N,Alpha = 10, proportion = 0.3),
...
test_that("Error on proportion value",{
  expect_error(modelMissLogSub(r0,r,Y = as.matrix(Original_Data[,1]),
                               X = as.matrix(Original_Data[,-1]),
