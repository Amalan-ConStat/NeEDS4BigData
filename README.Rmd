...
To explain these methods in detail $7$ articles are written and they are, 
...
Here, for $2,4$ and $6$ we assume the main effects model can describe the data. 
...
Under these conditions from $2-7$ we explore subsampling for $3$ given big data sets.
