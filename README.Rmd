...
_The R package "NeEDS4BigData" provides approaches to implement sampling methods to analyse big data._
...
Under these conditions from $2-7$ we explore sampling for three given big data sets.
